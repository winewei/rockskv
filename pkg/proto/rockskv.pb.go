...
const (
	...
	ErrorCode_NOT_PRIMARY         ErrorCode = 5 // Write rejected because node is not primary for this partition
	ErrorCode_EPOCH_FENCED        ErrorCode = 6 // Write rejected because epoch is stale (split-brain prevention)
)
...
type StoragePutRequest struct {
	...
	Epoch         uint64                 `protobuf:"varint,4,opt,name=epoch,proto3" json:"epoch,omitempty"` // Fencing token for split-brain prevention
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StoragePutRequest) GetEpoch() uint64 {
	if x != nil {
		return x.Epoch
	}
	return 0
...
type StorageDeleteRequest struct {
	...
	Key           []byte                 `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	PartitionId   uint32                 `protobuf:"varint,2,opt,name=partition_id,json=partitionId,proto3" json:"partition_id,omitempty"`
	Epoch         uint64                 `protobuf:"varint,3,opt,name=epoch,proto3" json:"epoch,omitempty"` // Fencing token for split-brain prevention
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StorageDeleteRequest) GetEpoch() uint64 {
	if x != nil {
		return x.Epoch
	}
	return 0
...
func (x *StorageSetFieldsRequest) GetEpoch() uint64 {
	if x != nil {
		return x.Epoch
	}
	return 0
...
func (x *StorageDeleteFieldRequest) GetEpoch() uint64 {
	if x != nil {
		return x.Epoch
	}
	return 0
...
func (x *StorageBatchPutRequest) GetEpoch() uint64 {
	if x != nil {
		return x.Epoch
	}
	return 0
...
type PartitionInfo struct {
	...
	// Fencing token - incremented on every primary change
...
func (x *PartitionInfo) GetEpoch() uint64 {
	if x != nil {
		return x.Epoch
	}
	return 0
...
const file_rockskv_proto_rawDesc = "" +
	...
	"\x05error\x18\x03 \x01(\x0e2\x12.rockskv.ErrorCodeR\x05error\"t\n" +
	...
	"\x05error\x18\x02 \x01(\x0e2\x12.rockskv.ErrorCodeR\x05error\"a\n" +
	...
	"\x05value\x18\x01 \x01(\fR\x05value\x12\x14\n" +
	"\x05found\x18\x02 \x01(\bR\x05found\x12(\n" +
	"\x05error\x18\x03 \x01(\x0e2\x12.rockskv.ErrorCodeR\x05error\"\xa0\x01\n" +
	...
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12(\n" +
	"\x05error\x18\x02 \x01(\x0e2\x12.rockskv.ErrorCodeR\x05error\"\x94\x01\n" +
	...
	"\fpartition_id\x18\x02 \x01(\rR\vpartitionId\x12\x14\n" +
	"\x05epoch\x18\x03 \x01(\x04R\x05epoch\"s\n" +
	...
	"partitions\x12\x18\n" +
	"\aversion\x18\x02 \x01(\x04R\aversion\"\x9b\x02\n" +
	"\rPartitionInfo\x12!\n" +
	...
	"\x0fmigration_state\x18\x06 \x01(\x0e2\x17.rockskv.MigrationStateR\x0emigrationState\x12\x14\n" +
	"\x05epoch\x18\a \x01(\x04R\x05epoch\"\x7f\n" +
	...
	"\n" +
	"ha_enabled\x18\x04 \x01(\bR\thaEnabled*\x8b\x01\n" +
	"\tErrorCode\x12\x06\n" +
	...
	"\vNOT_PRIMARY\x10\x05\x12\x10\n" +
	"\fEPOCH_FENCED\x10\x06*R\n" +
